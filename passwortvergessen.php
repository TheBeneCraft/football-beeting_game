<?php 
require('mysql.php');
$pdo = new PDO('mysql:host=localhost;dbname=em_tippspiel', 'username', 'passwort');
...
function random_string() {
 ...
 $str = md5(uniqid('beifg537398?', true));
 } 
 return $str;
}
...
if(isset($_GET['send']) ) {
 ...
 $betreff = "Neues Passwort für deinen Account auf www.benestippspiel.de"; //Ersetzt hier den Domain-Namen
 $from = "From: Vorname Nachname <info@benestippspiel.de>"; //Ersetzt hier euren Name und E-Mail-Adresse
